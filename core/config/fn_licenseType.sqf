...
switch (_mode) do
{
	case 0:
	{
		switch (_type) do
		{
			...
			case "home": {_var = "license_civ_home"};
			case "recreational": {_var = "license_civ_recreational"};
			case "airline": {_var = "license_civ_airline"};
	...
	case 1:
	{
		switch (_type) do
		{
			...
			case "license_civ_recreational": {_var = "recreational"};
			case "license_civ_airline": {_var = "airline"};
