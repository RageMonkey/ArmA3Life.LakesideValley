...
if ((player distance bank) < 10) then {
	...
	if({side _x == west} count playableUnits < 5) exitWith {["Please try again when 5 cops are online.",30,"red"] call A3L_Fnc_Msg;};
	...
	[] call fnc_placec4;
	[[0,format["The lakeside bank is being robbed!",profileName]],"life_fnc_broadcast",nil,false] spawn life_fnc_MP;
	[[0,format["The lakeside bank is being robbed!",profileName]],"life_fnc_broadcast",nil,false] spawn life_fnc_MP;
	[[0,format["The lakeside bank is being robbed!",profileName]],"life_fnc_broadcast",nil,false] spawn life_fnc_MP;
...
if ((player distance prisondoor) < 10) then {
	...
	[] call fnc_placec4;
    [[0,format["The lakeside jail is under siege!",profileName]],"life_fnc_broadcast",nil,false] spawn life_fnc_MP;
	[[0,format["The lakeside jail is under siege!",profileName]],"life_fnc_broadcast",nil,false] spawn life_fnc_MP;
	[[0,format["The lakeside jail is under siege!",profileName]],"life_fnc_broadcast",nil,false] spawn life_fnc_MP;
};